...
def create_pix_payment(user_id: int, amount: float) -> dict | None:
    """
    ...
    try:
        with httpx.Client() as client:
            response = client.post(CREATE_PIX_URL, headers=HEADERS, json=payload)
...
def check_payment_status(payment_id: str) -> str | None:
    """
